...
var templates = {
    ...
    cameraViewTemplate:"views/cameraViewTemplate.html",
    postViewTemplate:"views/postViewTemplate.html",
...
ViewAssembler.prototype.defaultView = function() {
    ...
    el.find("#post").on( this.CLICK_EVENT, onPostViewClick );
    el.find("#camera").on( this.CLICK_EVENT, onCameraViewClick );
    return el;
}
...
ViewAssembler.prototype.cameraView = function() {
    var el = $( templates.cameraViewTemplate );
    return el;
}
ViewAssembler.prototype.postView = function() {
    var el = $( templates.postViewTemplate );
    return el;
}
